                ...
                <div class="tab-content content" id="pills-tabContent">
                        ...
                        <div class="jumbotron border border-2 border border-info rounded rounded-o shadow shadow-md">
                            ...
                            <div class="m-3">
                                <div class="form-outline mb-4 input-container">
                                    <input type="text" name="reg_no" class="input" placeholder=" " id="form2Example11"
                                        onblur="Alphanumeric()" />
                            ...
                            <div class="m-3">
                                <div class="form-outline mb-4 input-container">
                                    <input type="text" name="sdate" class="input" id="form2Example22" placeholder=" "
                                        onfocus="datefun()" onblur="hideDatePicker();validateDate()" />
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="jumbotron border border-2 border border-info rounded rounded-o shadow shadow-md">
                            ...
                            <div class="m-3">
                                <div class="form-outline mb-4 input-container">
                                    <input type="text" id="adminId" name="reg_no" class="input" placeholder=" "
        ...
        <script>
            ...
            function validateDate() {
                ...
                if (!isDateNotExceedingCurrentDate(dateString)) {
                    $('#date_error').text("Enter a valid Date");
                    $("#date_error").css({
                        "color": "red",
                        "font-size": "10px"
                    });
