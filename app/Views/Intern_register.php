                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="jumbotron border border-2 border-info shadow shadow-sm  rounded ">
                                ...
                                <div class="m-3">
                                    <div class="form-outline mb-4 input-container">
                                        <input type="text" id="form2Example11 Enter Name" name="Enter Name"
                                            class="input" placeholder=" " />
                                        <label for="form2Example11" class="placeholder label">Enter Name</label>
                                    </div>
                                </div>
                                <div class="m-3">
                                    <div class="form-outline mb-4 input-container">
                                        <input type="text" id="form2Example11 email_id" name="email_id" class="input"
                                            placeholder=" " />
                                ...
                                <div class="m-3">
                                    <div class="form-outline mb-4 input-container">
                                        <input type="text" id="form2Example11 dept" name="dept" class="input"
                                            placeholder=" " />
                                ...
                                <div class="m-3">
                                    <div class="form-outline mb-4 input-container">
                                        <input type="text" id="form2Example11 mobile" name="mobile" class="input"
                                            placeholder=" " />
