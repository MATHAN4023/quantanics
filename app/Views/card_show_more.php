        ...
        <div class="row intern_request">
            <div class="col-lg-2 col-sm-3">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">Internship Request</button>

                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">Task Status</button>

                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false">Group chat</button>
                </div>
            </div>
            <div class="col-lg-10 col-sm-12">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade show active " id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        <!-- profile cards 1-->
                        <div class="row profile_permission_card">
                                        ...
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <div class="read-more-wrap">
                                                    ...
                                                    <div class="read-more-target">nithi ipsum dolor sit amet consectetur adipisicing elit.</div>
                                                </div>
                                            ...
                                            <div class="row" style="display:flex">
                                                <!-- <div class="col"></div> -->
                                                <div class="col d-flex justify-content-center gap-4"><button type="button" class="btn btn-outline-success">Accept</button>
                        ...
                        <div class="jumbotron border border-2 shadow shadow-sm rounded " style="">
                            <nav class="mt-4 m-3">
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Interns details</button>
                                    ...
                                    <button class="nav-link" id="nav-overdue-tab" data-bs-toggle="tab" data-bs-target="#nav-overdue" type="button" role="tab" aria-controls="nav-overdue" aria-selected="false">overdue</button>
                                </div>
                            </nav>
